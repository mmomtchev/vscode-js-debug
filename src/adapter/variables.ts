...
export class VariableStore {
  ...
  private extractFunctionFromCustomDescriptionGenerator(parameterNames: string[],
    generatorDefinition: string,
    catchAndReturnErrors: boolean,): string {
    const code = statementsToFunction(parameterNames, parseSource(generatorDefinition), true);
